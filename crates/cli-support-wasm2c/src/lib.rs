...
impl Generated {
    pub fn snippets(&self) -> &HashMap<String, Vec<String>> {
        match self {
            Self::InterfaceTypes => panic!(""),
            Self::Js(j) => &j.snippets,
            Self::C(c) => &c.snippets,
        }
    }
    pub fn local_modules(&self) -> &HashMap<String, String> {
        match self {
            Self::InterfaceTypes => panic!(""),
            Self::Js(j) => &j.local_modules,
            Self::C(c) => &c.local_modules,
        }
    }
    pub fn npm_dependencies(&self) -> &HashMap<String, (PathBuf, String)> {
        match self {
            Self::InterfaceTypes => panic!(""),
            Self::Js(j) => &j.npm_dependencies,
            Self::C(c) => &c.npm_dependencies,
        }
    }
    ...
    pub fn typescript(&self) -> bool {
        match self {
            Self::InterfaceTypes => panic!(""),
            Self::Js(j) => j.typescript,
            Self::C(c) => c.typescript,
        }
    }
...
/*
impl From<CGenerated> for JsGenerated {
    fn from(obj: CGenerated) -> Self {
        JsGenerated {
            mode: obj.mode,
            js: obj.js,
            ts: obj.ts,
            ...
            local_modules: obj.local_modules,
            npm_dependencies: obj.npm_dependencies,
            typescript: obj.typescript,
        }
    }
}
*/
...
impl Bindgen {
    ...
    pub fn wasm2c(&mut self, wasm2c: bool) -> Result<&mut Bindgen, Error> {
        if wasm2c {
            self.switch_mode(OutputMode::Wasm2c, "--target wasm2c")?;
            self.encode_into(EncodeInto::Always);
        }
        Ok(self)
    }
    ...
    pub fn generate_output(&mut self) -> Result<Output, Error> {
        ...
        let generated = if self.wasm_interface_types {
            ...
            if let OutputMode::Wasm2c = self.mode {
                Generated::C(CGenerated {
...
impl Output {
    ...
    fn _emit(&mut self, out_dir: &Path) -> Result<(), Error> {
        let wasm_name = match &self.generated {
            ...
            Generated::C(_) => format!("{}_bg", self.stem),
        };
        ...
        let gen = if let Generated::InterfaceTypes = &self.generated {
            return Ok(());
        }
        else {
            &self.generated
